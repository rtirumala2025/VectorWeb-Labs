...
ADD COLUMN IF NOT EXISTS ai_price_quote JSONB;
...
COMMENT ON COLUMN public.projects.ai_price_quote IS 'JSONB containing AI-generated price quote with features and reasoning';
